export const MSG = {
  ...
  auth: {
    ...
    resetLinkSent: 'إذا كان الحساب مسجلاً، تم إرسال رمز التحقق إلى رقمك',
    resetLinkInvalid: 'رمز غير صالح أو منتهي الصلاحية',
    ...
    otpExpired: 'انتهت صلاحية رمز التحقق. اطلب رمزاً جديداً',
    otpMaxAttempts: 'تجاوزت الحد الأقصى لمحاولات الإدخال. اطلب رمزاً جديداً',
    otpVerified: 'تم التحقق بنجاح. يمكنك الآن تعيين كلمة مرور جديدة',
    otpSent: 'تم إرسال رمز التحقق إلى رقمك',
    resetTokenMissing: 'رمز إعادة التعيين مفقود. ابدأ العملية من جديد',
  },
